...
$strSQL="SELECT cd.*, r.* , r.reagent_name AS label, concat('จำนวนตามสัญญา:',cd.contract_vol) AS rightText 
FROM reagent_detail r, contract_detail cd
WHERE cd.contract_id='".$b."' AND cd.reagent_id=r.reagent_id AND cd.is_cancel!=1 
AND r.is_cancel!=1";
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
