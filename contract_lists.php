...
$strSQL = "SELECT c.*, concat('เลขที่: ',c.contract_no) AS label, ch.hosp_id, c.comment AS rightText 
from contract c, contract_hosp ch 
where c.contract_id=ch.contract_id and ch.hosp_id='".$b."'and c.status='active' AND c.is_cancel!=1 AND ch.is_cancel!=1
